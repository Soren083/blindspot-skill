...
Blindspot Skill 主要是给那些正在用 AI Agent 做真实产品的人用的。

你不需要是很专业的程序员，也不需要是特别专业的产品经理。它最适合的场景是：你有一个产品想法、截图、bug、竞品参考，或者只是觉得“这个地方不太对”，但你很难在让 Agent 写代码前，把所有状态、接口、权限、边界、回归和发布风险都说清楚。

适合这些人：

- 用 Codex、Claude Code 或其他 Coding Agent 做产品的独立开发者、创业者、设计师、运营、内容创作者和行业专家
- 不太懂代码，但想让 Agent 在写代码前先把需求问清楚的人
- 想快速检查用户流程、成功状态、文案、边界情况和发布风险的产品经理
- 想让 Agent 不要一上来就写代码，而是先把产品盲点想清楚的工程师

这个 skill 不替代你的判断。它的作用是帮助你和 Agent 一起发现那些“你还没说清楚、Agent 也很可能没想到”的地方。
